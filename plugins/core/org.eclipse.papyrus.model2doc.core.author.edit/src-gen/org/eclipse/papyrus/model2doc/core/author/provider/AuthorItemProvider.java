...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.model2doc.core.author.Author} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AuthorItemProvider
	...
	protected void addFirstNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Author_firstName_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Author_firstName_feature", "_UI_Author_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				AuthorPackage.Literals.AUTHOR__FIRST_NAME,
				true,
				false,
				false,
	...
	protected void addLastNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Author_lastName_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Author_lastName_feature", "_UI_Author_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				AuthorPackage.Literals.AUTHOR__LAST_NAME,
				true,
				false,
				false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		case AuthorPackage.AUTHOR__LAST_NAME:
	...
	public ResourceLocator getResourceLocator() {
		return AuthorEditPlugin.INSTANCE;
	}
