...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.model2doc.emf.documentstructure.Paragraph} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
...
public class ParagraphItemProvider
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Paragraph_text_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", "_UI_Paragraph_text_feature", "_UI_Paragraph_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				DocumentStructurePackage.Literals.PARAGRAPH__TEXT,
				true,
				false,
				false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Paragraph_type") : //$NON-NLS-1$
				getString("_UI_Paragraph_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
