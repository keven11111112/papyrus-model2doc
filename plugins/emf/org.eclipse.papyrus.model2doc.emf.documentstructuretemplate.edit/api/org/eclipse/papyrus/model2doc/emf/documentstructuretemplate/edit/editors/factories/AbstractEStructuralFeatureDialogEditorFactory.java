...
import org.eclipse.papyrus.model2doc.emf.documentstructuretemplate.edit.internal.providers.EcoreLabelProvider;
import org.eclipse.swt.widgets.Composite;
import org.eclipse.ui.dialogs.ISelectionStatusValidator;

/**
 * Abstract EditorFactory to use to edit single reference with a dialog
 */
public abstract class AbstractEStructuralFeatureDialogEditorFactory extends EMFEditUIPropertyEditorFactory {
	...
	/**
	 * This method must be overriden to define these fields:
	 * <ul>
	 * <li>dialog title</li>
	...
	protected void configureCellEditor(final CustomExtendedDialogCellEditor cellEditor) {
		...
		if (this.editedFeature.isMany()) {
			...
			cellEditor.setDialogMessage(NLS.bind(Messages.AbstractEObjectReferenceDialogEditorFactory_DialogMessageSingleSelection, this.editedFeature.getEType().getName()));
		}
	}
	...
	public ILabelProvider getOrCreateLabelProvider() {
		if (this.labelProvider == null) {
			this.labelProvider = new EcoreLabelProvider();
		}
