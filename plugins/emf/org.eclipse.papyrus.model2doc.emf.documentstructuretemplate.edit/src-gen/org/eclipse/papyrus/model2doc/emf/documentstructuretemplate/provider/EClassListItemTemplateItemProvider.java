...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.model2doc.emf.documentstructuretemplate.EClassListItemTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class EClassListItemTemplateItemProvider extends EClassTemplateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EClassListItemTemplateItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DocumentStructureTemplatePackage.Literals.ICOMPOSED_SUB_LIST_ITEM_TEMPLATE__LIST_ITEM_TEMPLATE);
		}
	...
	/**
	 * This returns EClassListItemTemplate.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @generated
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EClassListItemTemplate")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((EClassListItemTemplate) object).getCustomItemLabel();
		return label == null || label.length() == 0 ? getString("_UI_EClassListItemTemplate_type") : //$NON-NLS-1$
				getString("_UI_EClassListItemTemplate_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EClassListItemTemplate.class)) {
