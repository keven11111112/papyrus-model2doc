...
import org.eclipse.papyrus.model2doc.core.builtintypes.provider.DefaultFileReferenceItemProvider;

import org.eclipse.papyrus.model2doc.emf.documentstructuretemplate.DocumentStructureTemplatePackage;
import org.eclipse.papyrus.model2doc.emf.documentstructuretemplate.InsertFileTemplate;

/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.model2doc.emf.documentstructuretemplate.InsertFileTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
 */
public class InsertFileTemplateItemProvider extends DefaultFileReferenceItemProvider {
	/**
	 ...
	 * @generated
	 */
	public InsertFileTemplateItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns InsertFileTemplate.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 *
	 * @generated
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InsertFileTemplate")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((InsertFileTemplate) object).getFilePath();
		return label == null || label.length() == 0 ? getString("_UI_InsertFileTemplate_type") : //$NON-NLS-1$
				getString("_UI_InsertFileTemplate_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(InsertFileTemplate.class)) {
