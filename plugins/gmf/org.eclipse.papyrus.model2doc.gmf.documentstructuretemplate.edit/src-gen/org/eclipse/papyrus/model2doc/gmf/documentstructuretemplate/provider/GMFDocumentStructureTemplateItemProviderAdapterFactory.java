...
public class GMFDocumentStructureTemplateItemProviderAdapterFactory extends GMFDocumentStructureTemplateAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	...
	public Adapter createGMFDiagramViewAdapter() {
		if (gmfDiagramViewItemProvider == null) {
			gmfDiagramViewItemProvider = new GMFDiagramViewItemProvider(this);
		}

		return gmfDiagramViewItemProvider;
	}
	...
	public void dispose() {
		if (gmfDiagramViewItemProvider != null) {
			gmfDiagramViewItemProvider.dispose();
		}
	}
