...
/**
 * This converter allows to convert a PapyrusTable into a String (using {@link PapyrusTable#getId()} and vice versa
 */
public class PapyrusTableViewTableKindIdDisplayConverter implements IDisplayConverter {
	...
	public Object displayToSemanticValue(final Object displayValue, final EObject editedObject) {
		...
		if (displayValue instanceof PapyrusTable) {
			return ((PapyrusTable) displayValue).getId();
		}
		return displayValue;
	}
