...
public class PapyrusNattableDocumentStructureTemplateSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case PapyrusNattableDocumentStructureTemplatePackage.TABLE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Papyrus Table View</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Papyrus Table View</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePapyrusTableView(PapyrusTableView object) {
		return null;
	}
...
} //PapyrusNattableDocumentStructureTemplateSwitch
