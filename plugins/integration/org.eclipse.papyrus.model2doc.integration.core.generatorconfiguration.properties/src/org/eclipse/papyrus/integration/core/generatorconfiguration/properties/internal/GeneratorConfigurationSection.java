 ...
 *
 *****************************************************************************/
package org.eclipse.papyrus.integration.core.generatorconfiguration.properties.internal;
...
/**
 * Author Property View section.
 * Adapted from the section defined for documentstructuretemplate
 */
public class GeneratorConfigurationSection extends AdvancedPropertySection {
		...
		if (selection instanceof IStructuredSelection && ((IStructuredSelection) selection).getFirstElement() instanceof EObject) {
			...
			this.page.setPropertySourceProvider(new AdapterFactoryContentProvider(adapterFactory) {
				...
				protected IPropertySource createPropertySource(final Object object, final IItemPropertySource itemPropertySource) {
					return GeneratorConfigurationSection.this.createPropertySource(object, itemPropertySource);
				}
			});
		} else {
	...
	private IPropertySource createPropertySource(Object object, IItemPropertySource itemPropertySource) {
		return new GeneratorConfigurationPropertySource(object, itemPropertySource);
	}
}