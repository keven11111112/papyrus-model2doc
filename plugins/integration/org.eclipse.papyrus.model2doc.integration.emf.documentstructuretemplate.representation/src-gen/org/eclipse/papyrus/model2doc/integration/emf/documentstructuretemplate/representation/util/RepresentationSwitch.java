...
public class RepresentationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RepresentationPackage.PAPYRUS_DOCUMENT_PROTOTYPE: {
			PapyrusDocumentPrototype papyrusDocumentPrototype = (PapyrusDocumentPrototype) theEObject;
	 ...
	 * @generated
	 */
	public T casePapyrusDocumentPrototype(PapyrusDocumentPrototype object) {
		return null;
	}
