...
import org.eclipse.papyrus.model2doc.integration.gmf.documentstructuretemplate.util.PapyrusGMFDocumentStructureTemplateAdapterFactory;
...
public class PapyrusGMFDocumentStructureTemplateItemProviderAdapterFactory extends PapyrusGMFDocumentStructureTemplateAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	...
	public Adapter createPapyrusGMFDiagramViewAdapter() {
		if (papyrusGMFDiagramViewItemProvider == null) {
			papyrusGMFDiagramViewItemProvider = new PapyrusGMFDiagramViewItemProvider(this);
		}

		return papyrusGMFDiagramViewItemProvider;
	}
		...
		protected static class CreationSwitch extends DocumentStructureTemplateSwitch<Object> {
			...
			public Object caseBody(Body object) {
				newChildDescriptors.add(createChildParameter(DocumentStructureTemplatePackage.Literals.BODY__BODY_PART_TEMPLATE,
						PapyrusGMFDocumentStructureTemplateFactory.eINSTANCE.createPapyrusGMFDiagramView()));
