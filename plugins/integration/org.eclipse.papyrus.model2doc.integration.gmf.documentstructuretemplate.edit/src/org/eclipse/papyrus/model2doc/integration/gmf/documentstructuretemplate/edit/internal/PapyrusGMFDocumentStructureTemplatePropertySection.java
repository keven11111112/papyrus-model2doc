...
/**
 * This class provides the section for the elements coming from PapyrusGMFDocumentStructureTemplate metamodel
 */
public class PapyrusGMFDocumentStructureTemplatePropertySection extends AbstractEObjectAdvancedPropertySection {
	 ...
	 *
	 */
	public PapyrusGMFDocumentStructureTemplatePropertySection() {
		super();
	}
	...
	public IPropertySource createPropertySource(final Object object, final IItemPropertySource itemPropertySource) {
		return new PapyrusGMFDocumentTemplateStructurePropertySource(object, itemPropertySource);
	}
}
