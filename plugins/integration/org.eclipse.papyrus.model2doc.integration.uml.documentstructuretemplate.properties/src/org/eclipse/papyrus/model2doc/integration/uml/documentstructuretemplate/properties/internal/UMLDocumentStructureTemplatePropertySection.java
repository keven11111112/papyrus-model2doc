...
/**
 * This class provides the section for the elements coming from UMLDocumentStructureTemplate metamodel
 */
public class UMLDocumentStructureTemplatePropertySection extends AbstractEObjectAdvancedPropertySection {
	 ...
	 *
	 */
	public UMLDocumentStructureTemplatePropertySection() {
		super();
	}
	...
	public IPropertySource createPropertySource(final Object object, final IItemPropertySource itemPropertySource) {
		return new UMLDocumentTemplateStructurePropertySource(object, itemPropertySource);
	}
}
