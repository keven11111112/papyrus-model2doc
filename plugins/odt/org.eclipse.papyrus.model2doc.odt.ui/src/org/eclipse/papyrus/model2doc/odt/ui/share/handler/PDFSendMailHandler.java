...
/**
 *  Handler class for sending e-mail with pdf document attached.
 *
 */
public class PDFSendMailHandler extends ShareDocumentHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		documentURL = getODTEditorService().exportDocument(document.getName(), documentURL, pdf, projectFolder);
