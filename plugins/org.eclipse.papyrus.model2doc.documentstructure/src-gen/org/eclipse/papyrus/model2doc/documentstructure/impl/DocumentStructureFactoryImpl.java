...
public class DocumentStructureFactoryImpl extends EFactoryImpl implements DocumentStructureFactory {
	...
	public EObject create(EClass eClass) {
		...
		case DocumentStructurePackage.EOBJECT_FEATURE_TEXT_SOURCE:
			return createEObjectFeatureTextSource();
		default:
	 ...
	 */
	@Override
	public EObjectFeatureTextSource createEObjectFeatureTextSource() {
		EObjectFeatureTextSourceImpl eObjectFeatureTextSource = new EObjectFeatureTextSourceImpl();
		return eObjectFeatureTextSource;
	}
