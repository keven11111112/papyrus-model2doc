 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.papyrus.model2doc.documentstructure.impl.ImageImpl#getTextSource <em>Text Source</em>}</li>
 * <li>{@link org.eclipse.papyrus.model2doc.documentstructure.impl.ImageImpl#getSubDocumentPart <em>Sub Document Part</em>}</li>
 * <li>{@link org.eclipse.papyrus.model2doc.documentstructure.impl.ImageImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImageImpl extends MinimalEObjectImpl.Container implements Image {
	...
	public NotificationChain basicSetTextSource(TextSource newTextSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocumentStructurePackage.IMAGE__TEXT_SOURCE, oldTextSource, newTextSource);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTextSource(TextSource newTextSource) {
		if (newTextSource != textSource) {
			...
			if (textSource != null) {
				msgs = ((InternalEObject) textSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocumentStructurePackage.IMAGE__TEXT_SOURCE, null, msgs);
			}
			if (newTextSource != null) {
				msgs = ((InternalEObject) newTextSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocumentStructurePackage.IMAGE__TEXT_SOURCE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentStructurePackage.IMAGE__TEXT_SOURCE, newTextSource, newTextSource));
		}
	}
	...
	public EList<DocumentPart> getSubDocumentPart() {
		if (subDocumentPart == null) {
			subDocumentPart = new EObjectContainmentEList<>(DocumentPart.class, this, DocumentStructurePackage.IMAGE__SUB_DOCUMENT_PART);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case DocumentStructurePackage.IMAGE__TEXT_SOURCE:
			return basicSetTextSource(null, msgs);
		case DocumentStructurePackage.IMAGE__SUB_DOCUMENT_PART:
