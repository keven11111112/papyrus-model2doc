 ...
 * </p>
 * <ul>
 * <li>{@link org.eclipse.papyrus.model2doc.documentstructure.impl.ParagraphImpl#getTextSource <em>Text Source</em>}</li>
 * <li>{@link org.eclipse.papyrus.model2doc.documentstructure.impl.ParagraphImpl#getSubDocumentPart <em>Sub Document Part</em>}</li>
 * <li>{@link org.eclipse.papyrus.model2doc.documentstructure.impl.ParagraphImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends MinimalEObjectImpl.Container implements Paragraph {
	...
	public NotificationChain basicSetTextSource(TextSource newTextSource, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DocumentStructurePackage.PARAGRAPH__TEXT_SOURCE, oldTextSource, newTextSource);
			if (msgs == null) {
				msgs = notification;
			} else {
	...
	public void setTextSource(TextSource newTextSource) {
		if (newTextSource != textSource) {
			...
			if (textSource != null) {
				msgs = ((InternalEObject) textSource).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DocumentStructurePackage.PARAGRAPH__TEXT_SOURCE, null, msgs);
			}
			if (newTextSource != null) {
				msgs = ((InternalEObject) newTextSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DocumentStructurePackage.PARAGRAPH__TEXT_SOURCE, null, msgs);
			}
			...
			eNotify(new ENotificationImpl(this, Notification.SET, DocumentStructurePackage.PARAGRAPH__TEXT_SOURCE, newTextSource, newTextSource));
		}
	}
	...
	public EList<DocumentPart> getSubDocumentPart() {
		if (subDocumentPart == null) {
			subDocumentPart = new EObjectContainmentEList<>(DocumentPart.class, this, DocumentStructurePackage.PARAGRAPH__SUB_DOCUMENT_PART);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case DocumentStructurePackage.PARAGRAPH__TEXT_SOURCE:
			return basicSetTextSource(null, msgs);
		case DocumentStructurePackage.PARAGRAPH__SUB_DOCUMENT_PART:
