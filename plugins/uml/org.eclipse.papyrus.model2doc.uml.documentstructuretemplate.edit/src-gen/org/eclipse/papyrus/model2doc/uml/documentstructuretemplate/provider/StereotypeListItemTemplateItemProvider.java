...
public class StereotypeListItemTemplateItemProvider extends MandatoryStereotypeWithEClassTemplateItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StereotypeListItemTemplate")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((StereotypeListItemTemplate) object).getCustomItemLabel();
		return label == null || label.length() == 0 ? getString("_UI_StereotypeListItemTemplate_type") : //$NON-NLS-1$
				getString("_UI_StereotypeListItemTemplate_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StereotypeListItemTemplate.class)) {
