...
public class StereotypePropertyReferenceTableViewItemProvider extends StereotypePropertyPartItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StereotypePropertyReferenceTableView")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((StereotypePropertyReferenceTableView) object).getCustomTitle();
		return label == null || label.length() == 0 ? getString("_UI_StereotypePropertyReferenceTableView_type") : //$NON-NLS-1$
				getString("_UI_StereotypePropertyReferenceTableView_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StereotypePropertyReferenceTableView.class)) {
