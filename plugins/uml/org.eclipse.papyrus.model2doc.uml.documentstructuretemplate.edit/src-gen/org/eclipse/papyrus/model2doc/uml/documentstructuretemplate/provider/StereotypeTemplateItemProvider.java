...
/**
 * This is the item provider adapter for a {@link org.eclipse.papyrus.model2doc.uml.documentstructuretemplate.StereotypeTemplate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class StereotypeTemplateItemProvider
	 ...
	 * @generated
	 */
	public StereotypeTemplateItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((StereotypeTemplate) object).getStereotypeQualifiedName();
		return label == null || label.length() == 0 ? getString("_UI_StereotypeTemplate_type") : //$NON-NLS-1$
				getString("_UI_StereotypeTemplate_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StereotypeTemplate.class)) {
