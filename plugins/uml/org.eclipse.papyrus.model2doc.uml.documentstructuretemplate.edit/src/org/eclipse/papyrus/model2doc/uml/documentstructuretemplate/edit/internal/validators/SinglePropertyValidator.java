...
/**
 * Validator for Single Selection of property
 */
public class SinglePropertyValidator extends AbstractSelectionStatusValidator {
	...
	public IStatus validate(Object[] selection) {
		...
		if (selection.length == 0) {
			...
			if (selection.length != 1 || false == firstSelection instanceof Property) {
