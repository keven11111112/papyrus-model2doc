...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Stereotype Part</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link org.eclipse.papyrus.model2doc.uml.documentstructuretemplate.impl.StereotypePartImpl#getStereotypeFilterRule <em>Stereotype Filter Rule</em>}</li>
 * <li>{@link org.eclipse.papyrus.model2doc.uml.documentstructuretemplate.impl.StereotypePartImpl#getStereotypeQualifiedName <em>Stereotype Qualified Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class StereotypePartImpl extends MinimalEObjectImpl.Container implements StereotypePart {
	/**
	...
	protected EClass eStaticClass() {
		return UMLDocumentStructureTemplatePackage.Literals.STEREOTYPE_PART;
	}
	...
	public void setStereotypeFilterRule(StereotypeFilterBehavior newStereotypeFilterRule) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, UMLDocumentStructureTemplatePackage.STEREOTYPE_PART__STEREOTYPE_FILTER_RULE, oldStereotypeFilterRule, stereotypeFilterRule));
		}
	}
	...
	public void setStereotypeQualifiedName(String newStereotypeQualifiedName) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, UMLDocumentStructureTemplatePackage.STEREOTYPE_PART__STEREOTYPE_QUALIFIED_NAME, oldStereotypeQualifiedName, stereotypeQualifiedName));
		}
	}
